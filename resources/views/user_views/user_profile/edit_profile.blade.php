@extends('layouts.user_simple.master')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter your bio" name="bio">{{ auth()->user()->bio }}</textarea>
                                    @error('bio')
                            ...
                            <div class="row">
                                        ...
                                        <div class="row phone-select-edit">
                                            <div class="col-2 pe-0">
                                                ...
                                                name="country_code" data-placeholder="">
                                                    ...
                                                    @endphp
                                                    @foreach (\App\Helpers\Helpers::getCountryCode() as $option)
                                                        <option class="option" value="{{ $option->calling_code }}"
                                                            data-image="{{ asset('assets/images/flags/' . $option->flag) }}"
                                                            {{ old('country_code', $user->country_code) === $option->calling_code ? 'selected' : '' }}>
                                                            {{ $option->calling_code }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="col-sm-6 col-md-5">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select btn-square" id="country" name="country_id"
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select btn-square" id="state" name="state_id">
