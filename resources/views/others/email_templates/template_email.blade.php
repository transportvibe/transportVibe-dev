...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:20px auto; border-radius:10px; background-color: #fff; -webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);">
  <tbody>
    <tr>
      <td>
            ...
            <tr class="header">
              ...
              <td class="menu" align="right" style="padding-right:15px;">
                <ul>
                  ...
                  <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">Whishlist</a></li>
                  <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">My cart</a></li>
                  <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">Contact</a></li>
                </ul>
              </td>
            </tr>
          </tbody>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <td><img class="img-fluid" src="{{ asset('assets/images/email-template/1.jpg') }}" alt="" style="width: 100%;"></td>
            </tr>
          </tbody>
        </table>
            ...
            <tr>
              <td>
                <div class="product-box hover">
                  <div class="product border-theme"><img class="img-fluid" src="{{ asset('assets/images/email-template/2.png') }}" alt="product"></div>
                  <div class="product-info">
                    <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i></div><a href="javascript:void(0)" tabindex="0" style="text-align: center;">
              ...
              <td>
                <div class="product-box hover">
                  <div class="product border-theme"><img class="img-fluid" src="{{ asset('assets/images/email-template/7.png') }}" alt="product"></div>
                  <div class="product-info">
                    <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i></div><a href="javascript:void(0)" tabindex="0" style="text-align: center;">
                      <h6 style="text-align: center;">When an unknown.</h6></a>
                    <h4 style="text-align: center;">$45.00</h4>
        ...
        <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:40px;">
          <tbody>
            ...
            <tr class="add-with-banner" align="center">
              <td><img class="img-fluid" style="border-radius:10px;" src="{{ asset('assets/images/email-template/3.png') }}"></td>
              <td>
                <div style="border-top:1px solid #5C61F2; mso-line-height-rule: exactly;" data-border-bottom-color="Week Border"></div><a href="javascript:void(0)">
                ...
                <div style="border-bottom:1px solid #5C61F2; mso-line-height-rule: exactly;" data-border-bottom-color="Week Border"></div>
              </td>
            </tr>
            <tr>
              <td height="45" style="mso-line-height-rule:exactly; line-height:45px;"></td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr align="center">
              <td><a href="javascript:void(0)"><img class="img-fluid" src="{{ asset('assets/images/email-template/cosmetic.jpg') }}" style="width:100%;"></a></td>
            </tr>
          </tbody>
        </table>
        <table class="product-banner" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
          <tbody>
            <tr class="add-with-banner" align="center">
              <td><a href="javascript:void(0)"><img class="img-fluid" src="{{ asset('assets/images/email-template/6.png') }}" style="border-radius:10px;"></a></td>
              <td><a href="javascript:void(0)"><img class="img-fluid" src="{{ asset('assets/images/email-template/5.png') }}" style="border-radius:10px;"></a></td>
            </tr>
          </tbody>
        </table>
                ...
                <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:20px;">
                  <tbody>
                    <tr class="temp-social">
                      ...
                      <td><a href="https://accounts.google.com/"><i class="fa fa-google-plus"></i></a></td>
