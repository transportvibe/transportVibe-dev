                    ...
                    <table style="margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr class="logo-sec" style="display: flex; align-items: center; justify-content: space-between; width: 650px;">
                          <td><img class="img-fluid" src="{{ asset('assets/images/logo/logo-1.png') }}" alt=""></td>
              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>you forgot your password for Crocs Admin. If this is true, click below to reset your password.</p>
                    <p style="text-align: center"><a href="{{ route('admin.reset_password') }}" style="padding: 10px; background-color:#5C61F2; color: #fff; display: inline-block; border-radius:30px; font-weight:700; padding:0.6rem 1.75rem;">Reset Password</a></p>
              ...
              <tbody>       
                <tr style="text-align: center">
                  <td> 
                    ...
                    <p style="color: #999; margin-bottom: 0">Powered By Crocs Admin</p>
                  </td>
                </tr>
              </tbody>
            </table>
