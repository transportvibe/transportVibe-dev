                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 30px"> 
                            ...
                            <div class="text-center"><a href="{{ route('admin.contacts') }}" style="padding: 10px; background-color: #5C61F2; color: #fff; display: inline-block; border-radius:30px; margin-bottom:18px; font-weight:600; padding:0.6rem 1.75rem;">Call To Action </a></div>
