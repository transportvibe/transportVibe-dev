  ...
  <head>
    ...
    <style type="text/css">
      ...
      @media only screen and (max-width:575px){
        ...
        .order-template tbody tr td, .order-template tbody tr th{
          width: 50px;
        }
      ...
      @media only screen and (max-width:480px){
        ...
        .order-template th, .order-template td h5{
        ...
        <tr>
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
              <tbody>
                <tr>
                  <td style="text-align: center;"><img src="{{ asset('assets/images/email-template/delivery-2.png') }}" alt="" style=";margin-bottom: 30px;border-radius:10px;"></td>
                </tr>
                <tr>
                  <td>
                    ...
                    <p style=" font-size: 14px; color:#717171;">Order Is Successfully Processsed And Your Order Is On The Way,</p>
                    <p style=" font-size: 14px; color:#717171;">Transaction ID : 267676GHERT105467,</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table class="content-detail" cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 10px;    margin-bottom: 10px;">
              <tbody>
                <tr>
                  <td style="background-color: rgba(62,95,206,0.02);border: 1px solid #eeeeee; padding: 15px;letter-spacing: 0.3px;width: 50%; border-radius:10px;">
                    <h5 style="font-size: 16px; font-weight: 600;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;border">Your Shipping Address</h5>
                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #717171;line-height: 21px;    margin-top: 0;">268 Cambridge Lane New Albany,<br> IN 47150268 Cambridge Lane <br>New Albany, IN 47150</p>
                  </td>
                  ...
                  <td style="padding: 30px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <p style="font-size:14px; margin:8px 0; color:#717171;">2024 - 25 Copy Right by Themeforest powerd by Pixel Strap</p>
                          </td>
                        </tr>
                        <tr>
