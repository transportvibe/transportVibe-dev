        ...
        <tr>
          <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr>
                  <td><img class="img-fluid" src="{{ asset('assets/images/email-template/delivery.png') }}" alt="" style=";margin-bottom: 30px; border-radius:10px;"></td>
                </tr>
                <tr>
                  <td>
            ...
            <table class="order-template" border="0" cellpadding="0" cellspacing="0" align="left">
              <tbody>
                ...
                <tr>
                  <td><img class="img-fluid" src="{{ asset('assets/images/email-template/1.png') }}" alt="" width="130"></td>
                ...
                <tr>
                  <td><img class="img-fluid" src="{{ asset('assets/images/email-template/4.png') }}" alt="" width="130"></td>
                  <td valign="top" style="padding-left: 15px;">
            ...
            <table class="content-detail" cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 30px;    margin-bottom: 30px;">
              <tbody>
                <tr>
                  ...
                  <td class="user-info" width="57" height="25"><img class="img-fluid" src="{{ asset('assets/images/email-template/space.jpg') }}" alt=" " height="25" width="57"></td>
            ...
            <table class="temp-social main-bg- text-center" id="5C61F2" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style=" margin-top:30px; border-radius:10px;">
              <tbody>
                <tr>
