                    ...
                    <div class="row">
                                        ...
                                        <div class="card-body socialprofile filter-cards-view">
                                            <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                ...
                                                <div class="flex-grow-1">
                                                    <h3 class="font-primary">My Page</h3><span class="d-block"><span><i
                                ...
                                <div class="card">
                                    ...
                                    <div class="collapse show" id="collapseThree" aria-labelledby="headingThree"
                                        ...
                                        <div class="card-body social-status filter-cards-view">
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                    src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                                <div class="flex-grow-1"><span class="d-block">Andew Jon</span>
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                    src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                                                <div class="flex-grow-1"><span class="d-block">Johny Waston</span>
                                                    <p>Commented on Shaun Park's <a href="#">Photo</a></p><span
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                    src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                                                <div class="flex-grow-1"><span class="d-block">Comeren Diaz</span>
                                                    <p>Commented on Shaun Park's <a href="#">Photo</a></p><span
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                    src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                                                <div class="flex-grow-1"><span class="d-block">Sarah Loren</span>
                                                    <p>Commented on Shaun Park's <a href="#">Photo</a></p><span
                                        ...
                                        <div class="card-body">
                                            <div class="new-users-social">
                                                <div class="d-flex"><img class="rounded-circle image-radius m-r-15"
                                                        src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                                                    <div class="flex-grow-1">
                                                        <h3 class="mb-0 f-w-700">ELANA</h3>
                                                        <p>January, 12,2024</p>
                                            ...
                                            <div class="timeline-content">
                                                <p>The only way to do something in depth is to work hard. I've always
                                                    thought of the T-shirt as the Alpha of the fashion alphabet. My
                                                    breakfast is very important. Everything I do is a matter of heart, body
                                                    and soul.</p>
                                                ...
                                                <div class="social-chat">
                                                    <div class="your-msg">
                                                        <div class="d-flex"><img
                                                            ...
                                                            <div class="flex-grow-1"><span>Jason Borne <span>1 Year Ago <i
                                                    ...
                                                    <div class="other-msg">
                                                        <div class="d-flex"><img
                                                            ...
                                                            <div class="flex-grow-1"><span>Alexendra Dhadio <span>1 Month
                                                                        Ago <i
                                                                            class="fa fa-reply font-primary"></i></span></span>
                                                    ...
                                                    <div class="other-msg">
                                                        <div class="d-flex"><img
                                                            ...
                                                            <div class="flex-grow-1"><span>Olivia Jon <span>15 Days Ago <i
                                                                            class="fa fa-reply font-primary"></i></span></span>
                                                    ...
                                                    <div class="your-msg">
                                                        <div class="d-flex"><img
                                                                ...
                                                                alt=""
                                                                src="{{ asset('assets/images/user/1.jpg') }}">
                                                            <div class="flex-grow-1"><span>Issa Bell <span>1 Year Ago <i
                                                                            class="fa fa-reply font-primary"></i></span></span>
                                                                <p>we are working for the dance and sing songs. this car is
                                                                    very awesome for the youngster. please vote this car and
                                                                    like our post</p>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="timeline-content">
                                                <p>I've always thought of the T-shirt as the Alpha of the fashion alphabet.
                        ...
                        <div class="col-xl-3 xl-30 box-col-30">
                            <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc1">
                                <div class="row">
                                    <div class="col-xl-12 xl-100 col-sm-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                                ...
                                                <div class="card-body filter-cards-view"><span class="mb-2 d-block">About
                                                    ...
                                                    <p>
                                                        ...
                                                        Agency in Pier 56.
                                                    </p><span class="mb-2 d-block">Favourite TV shows :</span>
                                                    <p>
                                                        Breaking Good, RedDevil, People of
                                                        Interest, The Running Dead,
                                                        Found, American Guy.
                                                    </p><span class="mb-2 d-block">Favourite Music Bands :</span>
                                                    <p>
                                                        Breaking Good, RedDevil, People of
                                                        Interest, The Running Dead,
                                                        Found, American Guy.
                                                    </p>
                                                    <div class="social-network theme-form"><span>Social Networks</span>
                    ...
                    <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="collapse show" id="collapseOneone" aria-labelledby="headingOneone"
                                        ...
                                        <div class="card-body socialprofile filter-cards-view">
                                            ...
                                            <div class="likes-profile text-center">
                                                <h3><span> <i class="fa fa-heart font-danger"></i> 884</span></h3>
                                            </div>
                                            <div class="text-center">35 New Likes This Week</div>
                                            <div class="customers text-center social-group">
                                                <ul>
                        ...
                        <div class="col-xl-6 col-md-7 box-col-40 xl-40">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header pb-0">
                                            <h3><span>Hobbies and Interests</span><span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span></h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span class="mb-2 d-block">Hobbies:</span>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span
                                                            class="mb-2 d-block">Favourite Music Bands / Artists:</span>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span class="mb-2 d-block">Favourite TV
                                                            Shows:</span>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span
                                                            class="mb-2 d-block">Favourite Books:</span>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span class="mb-2 d-block">Favourite
                                                            Movies:</span>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span
                                                            class="mb-2 d-block">Favourite Writers:</span>
                                            ...
                                            <div class="row details-about">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span
                                                            class="mb-2 d-block">Other Interests:</span>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header pb-0">
                                            <h3><span> Education and Employement</span><span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span></h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span>The New College of Design</span>
                                                        <p>2001 - 2006</p>
                                                        <p>Breaking Good, RedDevil, People of Interest, The Running Dead,
                                                            Found, American Guy.</p>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span>Digital Design
                                                            Intern</span>
                                                        <p>2006-2024</p>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span>Rembrandt Institute</span>
                                                        <p>2024</p>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span>UI/UX Designer</span>
                                                        <p>2001 - 2006</p>
                                                        <p>Breaking Good, RedDevil, People of Interest, The Running Dead,
                                                            Found, American Guy.</p>
                                                    </div>
                                            ...
                                            <div class="row details-about">
                                                <div class="col-sm-6">
                                                    <div class="your-details"><span>The Digital College</span>
                                                        <p>2024</p>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span>The New College of
                                                            Design</span>
                                                        <p>2024 - 2024</p>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon7"
                                                ...
                                                <div class="card-body filter-cards-view"><span
                                                        class="mb-2 d-block">About Me :</span>
                                                    <p>
                                                        Hi, I’m elana, I’m 30 and I work as a
                                                        web Designer for the “Daydreams”
                                                        Agency in Pier 56.
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img src="{{ asset('assets/images/avtar/7.jpg') }}"
                                                alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">1,908</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">34.0k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">897</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">875</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">12.0k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">1400</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">1,274</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">15.0k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">1874</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">500</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">8.0k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">570</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">460</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">2k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">350</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        ...
                                        <ul class="social-follow">
                                            <li>
                                                <h3 class="mb-0">547</h3><span class="f-light">Posts</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">3.5k</h3><span class="f-light">Followers</span>
                                            </li>
                                            <li>
                                                <h3 class="mb-0">822</h3><span class="f-light">Following</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
