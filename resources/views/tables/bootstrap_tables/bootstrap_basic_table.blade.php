    ...
    <div class="container-fluid basic_table">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Breckpoint Specific</h4><span>Use
                            <code>.table-responsive.custom-scrollbar"❴-sm|-md|-lg|-xl|-xxl❵"</code> functions like a heading
                            for a table. It helps users with screen readers to find a table and understand what it’s about
                            and decide if they want to read it.</span>
                    </div>
                    <div class="card-block row">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive custom-scrollbar">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Responsive Tables With Light Background</h4><span>A <code>.table-responsive.custom-scrollbar
                                ,.light-card</code> inside table element.</span>
                    </div>
                    <div class="card-block row">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive custom-scrollbar">
