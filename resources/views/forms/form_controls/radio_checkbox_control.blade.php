            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body common-flex main-radio-toggle">
                        <input class="btn-check radio-light-success" id="option1" type="radio" name="options"
                            checked="">
                        <label class="btn bg-light-success" for="option1">Checked</label>
                        <input class="btn-check radio-light-secondary" id="option2" type="radio" name="options">
                        <label class="btn bg-light-secondary" for="option2">Radio</label>
                        <input class="btn-check radio-light-secondary" id="option3" type="radio" name="options"
                            disabled="">
                        <label class="btn bg-light-secondary" for="option3">Disabled</label>
                        <input class="btn-check radio-light-secondary" id="option4" type="radio" name="options">
                        <label class="btn bg-light-secondary" for="option4">Radio</label>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
