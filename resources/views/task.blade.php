                            ...
                            <div class="ps-0">
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="pills-created" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex pb-0">
                                                <h4 class="mb-0">Created by me</h4><a href="#"><i class="me-2"
                                                    ...
                                                    <div class="table-responsive custom-scrollbar">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Digital News Report shows that
                                                                        podcasting is now a worldwide that has become one of
                                                                        the hottest topic.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">There are many tools available
                                                                        for testing websites, we’ve chosen classics: Chrome
                                                                        dev tools.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                    ...
                                    <div class="fade tab-pane" id="pills-todaytask" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Today's Tasks</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    <div class="fade tab-pane" id="pills-delayed" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Delayed Tasks</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    <div class="fade tab-pane" id="pills-upcoming" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Upcoming Tasks</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
                                    ...
                                    <div class="fade tab-pane" id="pills-weekly" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">This Week Tasks</h4><a href="#"><i
                                    ...
                                    <div class="fade tab-pane" id="pills-monthly" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">This Month Tasks</h4><a href="#"><i
                                                        class="me-2" data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
                                    ...
                                    <div class="fade tab-pane" id="pills-assigned" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Assigned to me</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body p-0">
                                                <div class="taskadd">
                                    ...
                                    <div class="fade tab-pane" id="pills-tasks" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">My tasks</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body p-0">
                                                <div class="taskadd">
                                    ...
                                    <div class="fade tab-pane" id="pills-notification" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Notification</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
                                    ...
                                    <div class="fade tab-pane" id="pills-newsletter" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0">Newsletter</h4><a href="#"><i class="me-2"
                                                        data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
