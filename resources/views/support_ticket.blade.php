                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-primary">
                            ...
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-secondary">
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-warning">
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-info">
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-success">
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6 box-col-6">
                                <div class="card ecommerce-widget bg-light-danger">
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
