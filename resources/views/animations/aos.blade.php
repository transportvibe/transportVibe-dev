    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>How to use it?</h4><span>All you have to do is to add <code>data-aos</code> attribute to html
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h4> Advanced settings</h4><span>These settings can be set both on certain elements, or as default
