                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                ...
                                <div class="flex-grow-1">
                                    <h3 class="f-w-600"><a href="#">UI Designer</a><span class="pull-right">
                            ...
                            <div class="job-description">
                                ...
                                <h3 class="mb-0">Your Education</h3>
                                <form class="form theme-form">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 xl-100">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select col-sm-12 job-select2">
                                ...
                                <h3 class="mb-0">Your Experience</h3>
                                <form class="form theme-form">
                                    <div class="row">
                                        <div class="col-xl-6 xl-100">
                                            <div class="mb-3">
