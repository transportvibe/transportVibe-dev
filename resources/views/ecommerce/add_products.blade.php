                                ...
                                <div class="col-xxl-3 col-xl-4 box-col-4e sidebar-left-wrapper">
                                    <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" id="gallery-product-tab"
                                                data-bs-toggle="pill" href="#gallery-product" role="tab"
                                        ...
                                        <li class="nav-item"><a class="nav-link" id="pricings-tab" data-bs-toggle="pill"
                                                href="#pricings" role="tab" aria-controls="pricings"
                                                aria-selected="false">
                                                <div class="nav-rounded">
                                                    <div class="product-icons">
                                                        <svg class="stroke-icon">
                                            ...
                                            <div class="sidebar-body">
                                                <form class="row g-2">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <p class="f-light">Improve product visibility by adding a
                                                            compelling description.</p>
                                                    </div>
                                                </form>
                                                ...
                                                <div class="product-upload">
                                                    ...
                                                    <form class="dropzone dropzone-light" id="multiFileUploadB"
                                                        ...
                                                        <div class="dz-message needsclick">
                                                            ...
                                                            <h6>Drag files here</h6><span class="note needsclick">Add
                                                    ...
                                                    <div class="row g-lg-4 g-3">
                                                        <div class="col-12">
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="category-buton"><a
                                                                            class="btn button-primary" href="#!"
                                            ...
                                            <div class="sidebar-body">
                                                <form class="price-wrapper">
                                                    <div class="row g-3 custom-input">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="form-label" for="sellingPrice">Selling price
                                                                <span class="txt-danger">*</span></label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="form-label" for="productStock1">Product
                                                                stocks<span class="txt-danger">*</span></label>
                                                            <input class="form-control" id="productStock1"
                                                                type="number">
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div class="sidebar-body advance-options">
                                                <ul class="nav nav-tabs border-tab mb-0" id="advance-option-tab"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link active"
                                                            id="manifest-option-tab" data-bs-toggle="tab"
                                                            href="#manifest-option" role="tab"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" id="additional-option-tab"
                                                            ...
                                                            aria-controls="additional-option"
                                                        ...
                                                        <div class="meta-body">
                                                            <form id="advance-tab">
                                                                <div class="row g-3 custom-input">
                                                                    ...
                                                                    <div class="col-lg-3 col-sm-6">
                                                                        <label class="form-label"
                                                                            for="exampleFormControlInputa">Stock Quantity
                                                                            <span class="txt-danger">*</span></label>
                                                                        <input class="form-control"
                                                                    ...
                                                                    <div class="col-lg-3 col-sm-6">
                                                                        <label class="form-label"
                                                                            for="exampleFormControlInputb">Restock Date
                                                                            <span class="txt-danger">*</span></label>
                                                                        <input class="form-control"
                                                                        ...
                                                                        <div class="row g-3">
                                                                            <div class="col-sm-6">
                                                                                <div class="row custom-input">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        ...
                                                                                        <p class="f-light">Add a new tag
                                                                                            title. Keywords should be simple
                                                                                            and accurate.</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="row product-tag">
                                                                                    <label
                                                                                        class="form-label col-12">Specific
                                                                                        Tags</label>
                                                                                    <div class="col-12">
                                                                ...
                                                                <div class="row g-3 custom-input">
                                                                    <div class="col-12">
                                                                        <div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="exampleFormControlInput1">Where
                                                                                    can I pick up my order?</label>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <p class="f-light">Decide if the product is
                                                                                    a digital or physical item. Shipping may
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
                                                                            ...
                                                                            <div class="col-md-4 col-sm-6">
                                                                                <input class="form-control"
                                                                                    id="inputCityb" type="number"
                                                                                    placeholder="Length[l]">
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-6">
                                                                                <input class="form-control"
                                                                                    id="inputCityc" type="number"
                                                                                    placeholder="Width[w]">
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <input class="form-control"
