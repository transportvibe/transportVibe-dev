...
<table style="width:1075px;margin:0 auto;">
    <tbody> 
      <tr> 
        <td> 
          <table style="width: 100%;background-image: url({{ asset('assets/images/email-template/invoice-3/bg-0.png') }});background-position: center;background-size: cover;background-repeat: no-repeat; border-radius: 10px;">
            <tbody>
              <tr>
                <td style="padding: 30px 0;"><img src="{{ asset('assets/images/logo/logo-1.png') }}" alt="logo">
                ...
                <td style="text-align:end; padding:30px 30px 30px 0;"><span style="display:block; line-height: 1.5; font-size:18px; color: #fff; font-weight:700;">Invoice</span><span style="display:block; line-height: 1.5; font-size:18px; color: #fff; font-weight:500;">Receipt #1923195</span><span style="display:block; line-height: 1.5; font-size:18px; color: #fff; font-weight:500;">May 02, 2024</span></td>
              </tr>
            </tbody>
          </table>
        </td>
          ...
          <table style="width: 100%;border-spacing:0;">
            <thead> 
              <tr style="background: #5C61F2;"> 
                <th style="padding: 18px 15px;text-align: left"><span style="color: #fff; font-size: 18px; font-weight: 600;">Description</span></th>
                <th style="padding: 18px 15px;text-align: center;border-inline: 3px solid #fff;"><span style="color: #fff; font-size: 18px; font-weight: 600;">Qty</span></th>
                <th style="padding: 18px 15px;text-align: center;border-right: 3px solid #fff;"><span style="color: #fff; font-size: 18px; font-weight: 600;">Price</span></th>
                <th style="padding: 18px 15px;text-align: center"><span style="color: #fff; font-size: 18px; font-weight: 600;">Subtotal</span></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style="padding: 18px 15px 18px 0;display:flex;align-items: center;gap: 10px; border-bottom:1px solid #52526C4D;"><span style="width: 3px; height: 37px; background-color:#5C61F2;"></span>
          ...
          <table style="width:100%;">
            <tbody>
              <tr style="display:flex; justify-content: space-between; margin:28px 0; align-items: center;">
                <td> <span style="color: #52526C; font-size: 16px; font-weight: 500;opacity: 0.8; font-weight: 600;">BANK TRANSFER</span>
                  <h4 style="font-weight:600; margin: 12px 0 5px 0; font-size: 18px; color:#5C61F2;">Leslie Alexander</h4><span style=" display:block; line-height: 1.5; color: #52526C; font-size: 18px; font-weight: 400;">Bank Account : 0981234098765</span><span style="line-height:1.6; color: #52526C; font-size: 18px; font-weight: 400;">Code : LEF098756</span>
                </td>
                <td><span style="color: #52526C;font-size: 16px; font-weight: 500;opacity: 0.8; font-weight: 600;">TOTAL AMOUNT</span>
                  <h4 style="font-weight:600; margin: 12px 0 5px 0; font-size: 26px;color:#5C61F2;">$175.00</h4><span style="color: #52526C; font-size: 16px; font-weight: 400; line-height: 1.5;">All Taxes included      </span>
                </td>
              </tr>
            </tbody>
          </table>
